...
#In[5]
def desenhar_cabecalho_rodape(pais,ano,canvas,doc, exibir_imagens=True, caminhos_imagens=None):
    canvas.saveState()
...
#In[5]:
def gerar_relatorio(nome_arquivo, df_exp, df_imp, pais, ano,logo):
    try:
        ...
        cabecalho_e_rodape_dados = partial(desenhar_cabecalho_rodape, pais, ano, exibir_imagens=logo, caminhos_imagens=arq_cam)
